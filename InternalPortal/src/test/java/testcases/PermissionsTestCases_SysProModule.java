...
public class PermissionsTestCases_SysProModule extends App
{
	...
	public void testCase1() throws Exception 
	{
		...
		try {		
			sysPro.verifyInventoryPermissionAsNone("PERMNS_071_Verify_Inventory_Permission_As_None", "Admin", "Users", "Inventory", 2);
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		//Check the Inventory as View permission 
		try {		
			sysPro.verifyInventoryPermissionAsNone("PERMNS_072_Verify_Inventory_Permission_As_View", "Admin", "Users", "Inventory", 3);
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		//Check the Jobs as None permission
		try {
			sysPro.verifyJobsPermissionAsNone("PERMNS_073_Verify_Jobs_Permission_As_None", "Admin", "Users", "Jobs", 2);
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		//Check the Jobs as View permission
		try {
			sysPro.verifyJobsPermissionAsNone("PERMNS_074_Verify_Jobs_Permission_As_View", "Admin", "Users", "Jobs", 3);
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		//Check the Orders as None permission
		try {			
			sysPro.verifyOrdersPermissionAsNone("PERMNS_075_Verify_Orders_Permission_As_None", "Admin", "Users", "Orders", 2);
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		//Check the Parts Purchase as None permission
		try {			
			sysPro.verifyPartsPurchasePermissionAsNone("PERMNS_076_Verify_Part Purchase_Permission_As_None", "Admin", "Users", "Part Purchase", 2);
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		//Check the Parts Purchase as View permission
		try {
			sysPro.verifyPartsPurchasePermissionAsNone("PERMNS_077_Part Purchase_Permission_As_View", "Admin", "Users", "Part Purchase", 3);
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		//
