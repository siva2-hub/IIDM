...
//	@Test(enabled = false)
	...
	public void testCase1() throws Exception {
		boolean res = quotes.verifyQuotesPermissionAsNone("PERMNS_053_Verify_QuoteForParts_Permission_As_None", "Admin", "Users", "Quote for Parts/Repairs",3, 2);
		if(res) {
		}else {
			App.logout();
		}
...
//	@Test(enabled = false)
	...
	public void testCase18() throws Exception {
		App.login();
		boolean res = quotes.verifyQuoteApprovalLimitPermissionAsNone_Quotes("PERMNS_070	_Verify_Quote Approval Limit__Permission_As_$50k and above_Quotes", "Admin", "Users", "Quote for Parts/Repairs","$50k and above");
		if(res) {
		}else {
			App.logout();
		}
